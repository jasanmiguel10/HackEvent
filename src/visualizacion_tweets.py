...
tweets['clase'][np.where(tweets['clase']==1)[0]]=1.15
tweets['clase'][ceros]=1.7
...
plt.savefig('testplot3.png',dpi=900)
plt.show()

hotspots=regiones[['avg']].sort_values(by='avg',ascending=False).iloc[range(int(regiones.shape[0]*cobertura))]
